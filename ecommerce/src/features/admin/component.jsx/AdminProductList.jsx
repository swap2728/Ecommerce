...
import {fetchAllProductsAsync,fetchProductsByFiltersAsync,selectProductById, fetchAllBrandsAsync, fetchAllCategoriesAsync, selectAllBrands, selectAllCategories, selectAllItems, selectAllProducts  } from "../../product/ProductSlice";
// import {
...
export default function AdminProductList() {
  ...
  return (
    <div>
      ...
      <Pagination products={products} page={page} setPage={setPage} handlePage={handlePage} totalItems={totalItems} filters={filters}>
      </Pagination>
    </div>
  );
}
              ...
              <div  className="group relative">
                <div className="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-75 lg:h-80">
                  <img
                    ...
                    alt={product.title}
                    className="h-90 w-full object-cover object-center lg:h-full lg:w-full"
                  />
                </div>
...
function Pagination({products, page, setPage, handlePage, totalItems,filters }) {
